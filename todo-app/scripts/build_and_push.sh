...
docker build -t ${IMAGE_SERVICE_NAME}:${TAG} ./image-service/ && docker push ${IMAGE_SERVICE_NAME}:${TAG}
docker build -t ${TODO_SERVICE_NAME}:${TAG} ./todo-service/ && docker push ${TODO_SERVICE_NAME}:${TAG}
